...
function no(){
    axios.post(prefix+ 'sendTimeCapsule', {
        type:JSON.stringify(sessionStorage.getItem('type')),
        message:JSON.stringify(sessionStorage.getItem('message')),
        time:JSON.stringify(sessionStorage.getItem('time')),
        send_offline:JSON.stringify(false),
    })
    .then(function (res) {
